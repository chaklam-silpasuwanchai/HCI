...
\frametitle{Mcdonald}
\begin{center}
Good design prevents \rule{2cm}{0.15mm}.
\end{center}
%\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
%
%\column{.65\textwidth} % Left column and width
...
\end{center}
	\centering
	\includegraphics[width=0.4\linewidth]{remote}
\end{frame}
...
\centering
\begin{figure}
	\includegraphics[width=0.6\linewidth]{usb}
\end{figure}
\end{frame}
...
\frametitle{Constraints}
\centering
\includegraphics[width=0.7\linewidth]{battery}
\end{frame}
...
\frametitle{Consistency}
\centering
\includegraphics[width=1\linewidth]{web}
\end{frame}
