...
%------------------------------------------------
\section{Big Picture} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%-----------------------------------------------
...
%		\item sum of squares (within and between)
%		\item mean squares
	\end{itemize}
\end{frame}
...
%------------------------------------------------
\section{Examples: Non-parametric tests} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%-----------------------------------------------
